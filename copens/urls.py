...
urlpatterns = patterns(
    ...
    url('^cql_tutorial/$',
        TemplateView.as_view(template_name='cql_tutorial.html'),
        name='cql_tutorial'),
    url('^search/$', search, name='search'),
    url('^download_conc$', download_conc, name='download_conc'),
    url('^download_wordlist/(.+)/$',
        download_wordlist,
    ...
    url('^about_copens/$',
        TemplateView.as_view(template_name="about_copens.html"),
        name="about_copens"),
    ...
    url(r'^accounts/register/$',
        RegistrationView.as_view(form_class=LopeRegForm),
